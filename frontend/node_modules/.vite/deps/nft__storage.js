...
var require_encode = __commonJS({
  "../node_modules/@ipld/car/node_modules/varint/encode.js"(exports2, module2) {
...
var require_decode = __commonJS({
  "../node_modules/@ipld/car/node_modules/varint/decode.js"(exports2, module2) {
...
var require_length = __commonJS({
  "../node_modules/@ipld/car/node_modules/varint/length.js"(exports2, module2) {
...
var require_varint = __commonJS({
  "../node_modules/@ipld/car/node_modules/varint/index.js"(exports2, module2) {
    module2.exports = {
...
var init_base = __esm({
  "../node_modules/multiformats/esm/src/bases/base.js"() {
    ...
    from = ({ name: name5, prefix, encode: encode12, decode: decode12 }) => new Codec(name5, prefix, encode12, decode12);
...
var init_cid = __esm({
  "../node_modules/multiformats/esm/src/cid.js"() {
    ...
    DAG_PB_CODE = 112;
    SHA_256_CODE = 18;
    encodeCID = (version2, code5, multihash) => {
...
var init_hasher = __esm({
  "../node_modules/multiformats/esm/src/hashes/hasher.js"() {
    init_digest();
    from2 = ({ name: name5, code: code5, encode: encode12 }) => new Hasher(name5, code5, encode12);
    Hasher = class {
...
var require_buffer = __commonJS({
  "../node_modules/bl/node_modules/buffer/index.js"(exports2) {
    ...
    Buffer.prototype.equals = function equals3(b) {
...
var decode11 = ({ ipnft, url, data }, paths) => new Token2(ipnft, url, mapWith(data, isEncodedURL, decodeURL, paths));
...
var encode11 = (input) => {
  const [map3, meta] = mapValueWith(input, isBlob3, encodeBlob, /* @__PURE__ */ new Map(), []);
...
var mapTokenInputBlobs = (input) => {
  return mapValueWith(input, isBlob3, encodeBlob, /* @__PURE__ */ new Map(), []);
};
...
// ../node_modules/nft.storage/src/lib.js
var import_it_pipe2 = __toESM(require_it_pipe());
...
var NFTStorage = class _NFTStorage {
  ...
  static async storeBlob(service, blob, options) {
    ...
    let cidString;
    try {
      const { cid, car } = await _NFTStorage.encodeBlob(blob, { blockstore });
      await _NFTStorage.storeCar(service, car, options);
   ...
   * @returns {Promise<CIDString>}
   */
  static async storeCar({ endpoint, rateLimiter = globalRateLimiter, ...token }, car, { onStoredChunk, maxRetries, maxChunkSize, decoders, signal } = {}) {
    const url = new URL("upload/", endpoint);
    const headers = {
      ..._NFTStorage.auth(token),
      "Content-Type": "application/car"
    };
    const targetSize = maxChunkSize || MAX_CHUNK_SIZE;
    const splitter = car instanceof Blob2 ? await TreewalkCarSplitter.fromBlob(car, targetSize, { decoders }) : new TreewalkCarSplitter(car, targetSize, { decoders });
  ...
  static async storeDirectory(service, filesSource, options) {
    ...
    let cidString;
    try {
      const { cid, car } = await _NFTStorage.encodeDirectory(filesSource, {
        blockstore
      });
      await _NFTStorage.storeCar(service, car, options);
      cidString = cid.toString();
  ...
  static async store(service, metadata, options) {
    const { token, car } = await _NFTStorage.encodeNFT(metadata);
    await _NFTStorage.storeCar(service, car, options);
    return token;
  }
  /**
   ...
   */
  static async status({ endpoint, rateLimiter = globalRateLimiter, ...token }, cid, options) {
   ...
   */
  static async delete({ endpoint, rateLimiter = globalRateLimiter, ...token }, cid, options) {
    const url = new URL(`${cid}/`, endpoint);
    await rateLimiter();
    const response = await fetch(url.toString(), {
      method: "DELETE",
...
function toAsyncIterable2(iterable) {
  return async function* () {
...
export {
  ...
  createRateLimiter,
  toAsyncIterable2 as toAsyncIterable,
  toGatewayURL
};
