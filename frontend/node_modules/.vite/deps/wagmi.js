...
import {
  ...
  mainnet,
  sepolia
} from "./chunk-P3FELVCM.js";
import {
  __privateAdd,
  __privateGet,
  __privateMethod,
  __privateSet
} from "./chunk-KKYGI5S7.js";
import {
  createPublicClient,
  fallback,
  http,
  parseGwei,
  webSocket
} from "./chunk-4DNGEDOW.js";
import "./chunk-PANOY3I4.js";
import "./chunk-AHBTWOBT.js";
import {
...
// node_modules/@tanstack/react-query/node_modules/@tanstack/query-core/build/lib/subscribable.mjs
...
// node_modules/@tanstack/react-query/node_modules/@tanstack/query-core/build/lib/focusManager.mjs
...
// node_modules/@tanstack/react-query/node_modules/@tanstack/query-core/build/lib/onlineManager.mjs
...
// node_modules/@tanstack/react-query/node_modules/@tanstack/query-core/build/lib/retryer.mjs
...
// node_modules/@tanstack/react-query/node_modules/@tanstack/query-core/build/lib/logger.mjs
var defaultLogger = console;

// node_modules/@tanstack/react-query/node_modules/@tanstack/query-core/build/lib/notifyManager.mjs
...
// node_modules/@tanstack/react-query/node_modules/@tanstack/query-core/build/lib/removable.mjs
var Removable = class {
  destroy() {
    this.clearGcTimeout();
  }
...
// node_modules/@tanstack/react-query/node_modules/@tanstack/query-core/build/lib/query.mjs
...
// node_modules/@tanstack/react-query/node_modules/@tanstack/query-core/build/lib/queryCache.mjs
...
// node_modules/@tanstack/react-query/node_modules/@tanstack/query-core/build/lib/mutation.mjs
...
// node_modules/@tanstack/react-query/node_modules/@tanstack/query-core/build/lib/mutationCache.mjs
...
// node_modules/@tanstack/react-query/node_modules/@tanstack/query-core/build/lib/queryClient.mjs
...
var QueryObserver = class extends Subscribable {
  ...
  createResult(query, options) {
    ...
    const result = {
      ...
      isLoadingError: isError3 && state.dataUpdatedAt === 0,
      isPaused: fetchStatus === "paused",
      isPlaceholderData,
      isPreviousData,
      isRefetchError: isError3 && state.dataUpdatedAt !== 0,
...
// node_modules/@tanstack/react-query/node_modules/@tanstack/query-core/build/lib/infiniteQueryObserver.mjs
...
// node_modules/@tanstack/react-query/node_modules/@tanstack/query-core/build/lib/mutationObserver.mjs
...
// node_modules/@tanstack/query-persist-client-core/node_modules/@tanstack/query-core/build/lib/subscribable.mjs
...
// node_modules/@tanstack/query-persist-client-core/node_modules/@tanstack/query-core/build/lib/utils.mjs
...
function scheduleMicrotask2(callback) {
  sleep2(0).then(callback);
}

// node_modules/@tanstack/query-persist-client-core/node_modules/@tanstack/query-core/build/lib/focusManager.mjs
var FocusManager2 = class extends Subscribable2 {
  constructor() {
    super();
    this.setup = (onFocus) => {
...
var focusManager2 = new FocusManager2();

// node_modules/@tanstack/query-persist-client-core/node_modules/@tanstack/query-core/build/lib/onlineManager.mjs
var onlineEvents2 = ["online", "offline"];
var OnlineManager2 = class extends Subscribable2 {
  constructor() {
    super();
    this.setup = (onOnline) => {
      if (!isServer2 && window.addEventListener) {
        const listener = () => onOnline();
        onlineEvents2.forEach((event) => {
          window.addEventListener(event, listener, false);
        });
        return () => {
          onlineEvents2.forEach((event) => {
...
var onlineManager2 = new OnlineManager2();

// node_modules/@tanstack/query-persist-client-core/node_modules/@tanstack/query-core/build/lib/notifyManager.mjs
function createNotifyManager2() {
  let queue = [];
  let transactions = 0;
  let notifyFn = (callback) => {
    callback();
...
var notifyManager2 = createNotifyManager2();

// node_modules/@tanstack/query-persist-client-core/node_modules/@tanstack/query-core/build/lib/hydration.mjs
    ...
    if (persistedClient) {
      if (persistedClient.timestamp) {
        ...
        if (expired || busted) {
          ...
          hydrate2(queryClient, persistedClient.clientState, hydrateOptions);
        }
      } else {
        persister.removeClient();
      }
...
async function persistQueryClientSave({
  ...
  const persistClient = {
    buster,
    timestamp: Date.now(),
    clientState: dehydrate2(queryClient, dehydrateOptions)
  };
...
// node_modules/wagmi/node_modules/zustand/esm/shallow.mjs
...
async function fetchEnsAddress({
  ...
  const { normalize } = await import("./ens-4IFTR5UR.js");
  const publicClient = getPublicClient({ chainId });
...
function parseQueryArgs3(arg1, arg2, arg3) {
  if (!isQueryKey2(arg1)) {
    return arg1;
  }
  if (typeof arg2 === "function") {
...
function useInfiniteQuery2(arg1, arg2, arg3) {
  const parsedOptions = parseQueryArgs3(arg1, arg2, arg3);
